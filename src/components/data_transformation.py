...
class DataTransformationConfig:
    preprocessor_obj_file_path=os.path.join('artifacts','preprocessor.pkl') #GIVING THE PATH OF PICKLE FILE
                                                                            #PICKLE FILE - SERIALIZED FILE
...
class DataTransformation:
    ...
    def initaite_data_transformation(self,train_path,test_path):  # WE GET THESE PATH FROM ARTIFACTS
        try:
